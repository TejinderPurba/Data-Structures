...
*@param printData function pointer to a function that prints out a data element of the table
**/
...
/**Updates a Node in the hash table.
*@pre hashTable type must exist and have data allocated to it
*@param hashTable pointer to the hash table
*@param key integer that represents the data (eg 35->"hello")
*@param data pointer to new generic data that is to be updated in the list
**/
